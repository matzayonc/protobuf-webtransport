...
goog.provide('proto.chat.UpdateRequest');
...
proto.chat.UpdateRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.chat.UpdateRequest.repeatedFields_, null);
};
 ...
 * @const
 */
proto.chat.UpdateRequest.repeatedFields_ = [1];
 ...
 * @return {!Array<string>}
 */
proto.chat.UpdateRequest.prototype.getMessagesList = function() {
 ...
 */
proto.chat.UpdateRequest.prototype.setMessagesList = function(value) {
 ...
 * @return {!proto.chat.UpdateRequest} returns this
 */
proto.chat.UpdateRequest.prototype.addMessages = function(value, opt_index) {
 ...
 * @return {!proto.chat.UpdateRequest} returns this
 */
proto.chat.UpdateRequest.prototype.clearMessagesList = function() {
